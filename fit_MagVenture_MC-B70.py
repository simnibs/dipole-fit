...
#factor of 3 will use 32k measurement points an require ~5GB
subsample_factor = 3
...
# measuremets requires a lot of memory, this can be reduced by decreasing the number of measurements or 
